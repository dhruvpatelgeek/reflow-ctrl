...
;Pins Config (cseg)
    ...
    MY_SCLK      EQU  P2.3
    alarm4        equ  P2.4
    on_off_switch equ  P2.5
    Button_min    equ  P2.6
    Button_hour   equ  P2.7
...
Reset_timer:
	...
	lcall Display_time             ; Display the new value
    ret
Display_time:
...
MainProgram:
    ...
    Forever: 
        ...
        ;-----HOME BUTTON-------;
        ;jb HOME_BUTTON, home_page  ; if the 'BOOT' button is not pressed skip
        ;Wait_Milli_Seconds(#50)	; Debounce delay.  This macro is also in 'LCD_4bit.inc'
        ;jb HOME_BUTTON, home_page  ; if the 'BOOT' button is not pressed skip
        ;jnb HOME_BUTTON, $		; Wait for button release.  The '$' means: jump to same instruction.
        ; A valid press of the 'BOOT' button has been detected, reset the BCD counter.
	    ; But first stop timer 2 and reset the milli-seconds counter, to resync everything.
        ;loop_a:
        ;-----------------------;
